...
static void ImGui_ImplSDL2_UpdateMousePosAndButtons() {
	...
	SDL_Window* hovered_window = SDL_HAS_MOUSE_FOCUS_CLICKTHROUGH
									 ? SDL_GetMouseFocus()
									 : NULL; // This is better but is only reliably useful with SDL 2.0.5+ and
	...
	if(bd->MouseCanUseGlobalState) {
		...
		// the upper-left corner of the app window) Unlike local position obtained earlier this will be valid when
