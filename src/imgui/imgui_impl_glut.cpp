...
bool ImGui_ImplGLUT_Init() {
	...
	// Glut has 1 function for characters and one for "special keys". We map the characters in the 0..255 range and the
	// keys above.
...
void ImGui_ImplGLUT_KeyboardFunc(unsigned char c, int x, int y) {
	...
	// Store letters in KeysDown[] array as both uppercase and lowercase + Handle GLUT translating CTRL+A..CTRL+Z
	// as 1..26. This is a hacky mess but GLUT is unable to distinguish e.g. a TAB key from CTRL+I so this is probably
