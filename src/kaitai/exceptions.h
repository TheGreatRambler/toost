...
namespace kaitai {
	...
	public:
		validation_failed_error(const std::string what, kstream* io, const std::string src_path)
			: kstruct_error(
				"at pos " + kstream::to_string(static_cast<int>(io->pos())) + ": validation failed: " + what, src_path)
			, m_io(io) { }
	 ...
	 */
	template <typename T> class validation_not_equal_error : public validation_failed_error {
	public:
	 ...
	 */
	template <typename T> class validation_less_than_error : public validation_failed_error {
	public:
	 ...
	 */
	template <typename T> class validation_greater_than_error : public validation_failed_error {
	public:
	 ...
	 */
	template <typename T> class validation_not_any_of_error : public validation_failed_error {
	public:
	 ...
	 */
	template <typename T> class validation_expr_error : public validation_failed_error {
	public:
